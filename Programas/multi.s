...
// Descripción: Multiplica dos números y muestra el resultado en consola
// Versión: 1.0
// ============================================
//
// using System;
...
//     static void Main()
//     {
//         int num1 = 7;  // Primer número
//         int num2 = 6;  // Segundo número
//         int resultado = num1 * num2; // Multiplicar los dos números
//
...
// }
.section .data
num1:       .word 7            // Primer número (32 bits)
num2:       .word 6            // Segundo número (32 bits)
...
_start:
    ...
    mul w0, w1, w2             // w0 = w1 * w2 (resultado)
