...
// Fecha: 07/Nov/2024
// Programa: suma.s
// Descripción: Sumar dos números y mostrar el resultado en consola
// Versión: 1.2
// ============================================
//
// using System;
...
//         int num2 = 27; // Segundo número
//         int resultado = num1 + num2; // Sumar los dos números
//
...
.section .data
num1:       .word 15           // Primer número (32 bits)
num2:       .word 27           // Segundo número (32 bits)
...
_start:
    ...
    ldr x1, =num1              // Dirección de num1 en x1
    ldr w1, [x1]               // Cargar valor de num1 en w1 (32 bits)
    ldr x2, =num2              // Dirección de num2 en x2
    ldr w2, [x2]               // Cargar valor de num2 en w2 (32 bits)

    // Sumar los dos números
    add w0, w1, w2            // w0 = w1 + w2 (resultado)
...
convert_loop:
    ...
    strb w5, [x1, -1]!       // Almacenar carácter
    mov w0, w4               // Actualizar w0
