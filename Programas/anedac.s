...
invertir_cadena:
    mov x2, #0                        // Índice inicial i = 0
    sub x1, x1, #1                    // Último índice j = longitud - 1

invertir_loop:
    cmp x2, x1                        // Compara i y j
    bge end_invertir                  // Si i >= j, terminar

    ldrb w3, [x0, x2]                 // Cargar el carácter en posición i
    ldrb w4, [x0, x1]                 // Cargar el carácter en posición j
    strb w4, [x0, x2]                 // Escribir el carácter en j en i
    strb w3, [x0, x1]                 // Escribir el carácter en i en j
